	...
	if(Copy_pu8ReturnValue != NULL)
	{
		...
		if((Copy_u8Port >= DIO_u8PORTA) && (Copy_u8Port <= DIO_u8PORTD))
		{
			if((Copy_u8Pin >= DIO_u8PIN0) && (Copy_u8Pin <= DIO_u8PIN7))
			{
				switch(Copy_u8Port)
				{
				case DIO_u8PORTA : *Copy_pu8ReturnValue = GET_BIT(PORTA , Copy_u8Pin); break;
				case DIO_u8PORTB : *Copy_pu8ReturnValue = GET_BIT(PORTB , Copy_u8Pin) ; break;
				case DIO_u8PORTC : *Copy_pu8ReturnValue = GET_BIT(PORTC , Copy_u8Pin) ; break;
				case DIO_u8PORTD : *Copy_pu8ReturnValue = GET_BIT(PORTD , Copy_u8Pin) ; break;
				}
				Local_enuErrorState = ES_OK;
			}
			else
